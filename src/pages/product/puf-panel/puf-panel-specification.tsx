...
const PRODUCT_JSONLD = {
  ...
  offers: {
    ...
    priceCurrency: 'INR',
    lowPrice: '1050',
    url: 'https://www.samanportable.com/product/puf-panel/puf-panel-specification',
  },
};
      ...
      <main className="bg-background pb-24 lg:pb-12">
        <div className="mx-auto max-w-7xl container-padding pt-4">
          ...
          <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-12 lg:gap-8">
            <div className="order-3 lg:order-1 lg:col-span-3 lg:sticky lg:top-24 lg:max-h-[80vh] lg:overflow-y-auto">
              <RelatedProductsRail
                ...
                items={[PUF_CATALOG.hub, PUF_CATALOG.house, PUF_CATALOG.coldStorage, PUF_CATALOG.wall, PUF_CATALOG.price, PUF_CATALOG.roofing, PUF_CATALOG.sandwich]}
              />
            </div>
          ...
          <div className="mt-8 space-y-8">
            <RelatedProductsRail items={[PUF_CATALOG.hub, PUF_CATALOG.house, PUF_CATALOG.coldStorage, PUF_CATALOG.wall, PUF_CATALOG.price, PUF_CATALOG.roofing, PUF_CATALOG.sandwich]} />
            <CertBadgeStrip />
          </div>
        </div>
      </main>
