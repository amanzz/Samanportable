...
// Dynamic import for LongformContent to add TOC functionality
const LongformContent = dynamic(() => import('../../../components/LongformContent'), {
  ssr: false,
        ...
        <>
          ...
          <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              ...
              {/* Full Description with TOC */}
              <div className="mt-4">
                <LongformContent 
                  content={transformedProduct.description || transformedProduct.content || ''}
