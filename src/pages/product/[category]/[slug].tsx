...
// Dynamic import for LongformContent to avoid SSR issues
...
const ProductDetails = ({ product, category, slug, relatedProducts, rankMathSEO }: ProductDetailsProps) => {
    ...
    <Layout>
      {!transformedProduct ? (
        ...
        <>
          ...
          {/* Fallback SEO when RankMath data is not available */}
          {!rankMathSEO && (
            <SEO
