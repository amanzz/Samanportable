...
const ContainerOffice30x8Rental = () => {
  const features = [
    "Spacious 240 sq ft interior space",
  ...
  const specifications = [
    { label: "Dimensions", value: "30' x 8' x 8.5'" },
    { label: "Floor Area", value: "240 sq ft" },
    ...
    { label: "Weight", value: "Approx. 2.5 tons" }
  ];

  const rentalTerms = [
    { title: 'Flexible Rental Duration', description: 'Short-term is 6 months minimum and long-term is one year or more.' },
    { title: 'Security Deposits', description: '1.5 lakhs within Bangalore and 2 lakhs outside Bangalore.' },
  ...
  return (
    <Layout>
      <UnifiedSEO
        fallbackTitle="30x8 Container Office Rental - Saman Portable"
        fallbackDescription="Rent 30x8 ft container offices in Bangalore. High-quality, spacious container offices perfect for temporary offices, accommodation, and commercial spaces. Flexible rental terms available."
        fallbackCanonical="https://www.samanportable.com/container-rent-services/30x8-container-office-rental"
      ...
      <Head>
        <script
          ...
          dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Product\", \"@id\": \"https://www.samanportable.com/container-rent-services/30x8-container-office-rental#product\", \"name\": \"30x8 Container Office Rental\", \"description\": \"240 sq ft container office for rent in Bangalore and Delhi NCR. Repositionable, configurable interiors for medium teams, workstations and meeting rooms.\", \"image\": [\"https://www.samanportable.com/hero-image/saman-portable-office-cabin-bangalore.webp\"], \"category\": \"Container Office Rental\", \"brand\": {\"@id\": \"https://www.samanportable.com/#organization\"}, \"additionalProperty\": [{\"@type\": \"PropertyValue\", \"name\": \"Structural warranty\", \"value\": \"5 years\"}, {\"@type\": \"PropertyValue\", \"name\": \"Standard warranty (fittings)\", \"value\": \"1 year, extendable to 2 years on request\"}], \"offers\": {\"@type\": \"Offer\", \"businessFunction\": \"http://purl.org/goodrelations/v1#LeaseOut\", \"priceCurrency\": \"INR\", \"price\": \"22000\", \"availability\": \"https://schema.org/InStock\", \"seller\": {\"@id\": \"https://www.samanportable.com/#organization\"}, \"eligibleDuration\": {\"@type\": \"QuantitativeValue\", \"minValue\": 6, \"unitCode\": \"MON\"}, \"priceSpecification\": {\"@type\": \"UnitPriceSpecification\", \"minPrice\": \"22000\", \"maxPrice\": \"32000\", \"priceCurrency\": \"INR\", \"unitCode\": \"MON\"}}}" }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://www.samanportable.com/container-rent-services/30x8-container-office-rental"
              }
            ]
          }) }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "@id": "https://www.samanportable.com/container-rent-services/30x8-container-office-rental#service", "name": "30x8 Container Office Rental", "serviceType": "Container Office Rental", "description": "Flexible rental of a 30x8 container office in Bangalore and Delhi NCR, with delivery, professional installation, maintenance support and transparent, refundable-deposit terms.", "provider": {"@id": "https://www.samanportable.com/#organization"}, "areaServed": [{"@type": "Place", "name": "Bengaluru"}, {"@type": "Place", "name": "Delhi NCR"}], "url": "https://www.samanportable.com/container-rent-services/30x8-container-office-rental"}) }}
        />
      </Head>
          ...
          <section className="relative py-16 bg-[#0A3D2A]">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                30x8 Container Office Rental
              </h1>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Spacious 240 sq ft container offices perfect for temporary offices, accommodation, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 30x8 container offices provide the ideal solution for medium-scale operations. 
                    With 240 square feet of usable area, these container offices are perfect for 
            ...
            <div className="max-w-7xl mx-auto container-padding">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg">
                  Detailed specifications of our 30x8 container office rental units
                </p>
              </div>
          ...
          <section className="section-padding bg-slate-50">
            <div className="max-w-7xl mx-auto container-padding">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Medium Offices", description: "Perfect for project-based work or overflow office space" },
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 30x8 Container Office?
              </h2>
...
export default ContainerOffice30x8Rental;
