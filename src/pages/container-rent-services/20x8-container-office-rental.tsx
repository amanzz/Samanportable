...
const ContainerOffice20x8Rental = () => {
  ...
  return (
    <Layout>
      <UnifiedSEO
        fallbackTitle="20x8 Container Office Rental - Saman Portable"
      ...
      <Head>
        <script
          ...
          dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Product\", \"@id\": \"https://www.samanportable.com/container-rent-services/20x8-container-office-rental#product\", \"name\": \"20x8 Container Office Rental\", \"description\": \"160 sq ft container office for rent in Bangalore and Delhi NCR. Efficient layout for small teams and remote work sites with rapid deployment.\", \"image\": [\"https://www.samanportable.com/hero-image/saman-portable-office-cabin-bangalore.webp\"], \"category\": \"Container Office Rental\", \"brand\": {\"@id\": \"https://www.samanportable.com/#organization\"}, \"additionalProperty\": [{\"@type\": \"PropertyValue\", \"name\": \"Structural warranty\", \"value\": \"5 years\"}, {\"@type\": \"PropertyValue\", \"name\": \"Standard warranty (fittings)\", \"value\": \"1 year, extendable to 2 years on request\"}], \"offers\": {\"@type\": \"Offer\", \"businessFunction\": \"http://purl.org/goodrelations/v1#LeaseOut\", \"priceCurrency\": \"INR\", \"price\": \"16000\", \"availability\": \"https://schema.org/InStock\", \"seller\": {\"@id\": \"https://www.samanportable.com/#organization\"}, \"eligibleDuration\": {\"@type\": \"QuantitativeValue\", \"minValue\": 6, \"unitCode\": \"MON\"}, \"priceSpecification\": {\"@type\": \"UnitPriceSpecification\", \"minPrice\": \"16000\", \"maxPrice\": \"22000\", \"priceCurrency\": \"INR\", \"unitCode\": \"MON\"}}}" }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://www.samanportable.com/container-rent-services/20x8-container-office-rental"
              }
            ]
          }) }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "@id": "https://www.samanportable.com/container-rent-services/20x8-container-office-rental#service", "name": "20x8 Container Office Rental", "serviceType": "Container Office Rental", "description": "Flexible rental of a 20x8 container office in Bangalore and Delhi NCR, with delivery, professional installation, maintenance support and transparent, refundable-deposit terms.", "provider": {"@id": "https://www.samanportable.com/#organization"}, "areaServed": [{"@type": "Place", "name": "Bengaluru"}, {"@type": "Place", "name": "Delhi NCR"}], "url": "https://www.samanportable.com/container-rent-services/20x8-container-office-rental"}) }}
        />
      </Head>
