...
const PortaCabin30x10Rental = () => {
  ...
  return (
    <Layout>
      <UnifiedSEO
        fallbackTitle="30x10 Porta Cabin Rental - Saman Portable Office Solutions"
        fallbackDescription="Rent 30x10 ft porta cabins in Bangalore. High-quality, spacious portable cabins perfect for offices, accommodation, and temporary structures. Flexible rental terms available."
