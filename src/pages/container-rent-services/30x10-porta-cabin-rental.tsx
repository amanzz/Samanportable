...
const PortaCabin30x10Rental = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>30x10 Porta Cabin Rental - Saman Portable Office Solutions</title>
        <meta name="description" content="Rent 30x10 ft porta cabins in Bangalore. High-quality, spacious portable cabins perfect for offices, accommodation, and temporary structures. Flexible rental terms available." />
      </Head>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 30x10 porta cabins provide the ideal balance of space and portability. 
                    With 300 square feet of usable area, these cabins are perfect for temporary 
                    offices, accommodation, retail spaces, and commercial applications.
                  </p>
          ...
          <section className="section-padding bg-slate-50">
            <div className="max-w-7xl mx-auto container-padding">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Temporary Offices", description: "Perfect for project-based work or overflow office space" },
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 30x10 Porta Cabin?
              </h2>
