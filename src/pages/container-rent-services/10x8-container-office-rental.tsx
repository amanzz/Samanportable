...
const ContainerOffice10x8Rental = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>10x8 Container Office Rental - Saman Portable Office Solutions</title>
        <meta name="description" content="Rent 10x8 ft container offices in Bangalore. Compact, high-quality container offices perfect for small offices, accommodation, and temporary structures. Flexible rental terms available." />
      </Head>
