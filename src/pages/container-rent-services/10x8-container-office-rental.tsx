...
const ContainerOffice10x8Rental = () => {
  const features = [
    "Compact 80 sq ft interior space",
  ...
  const specifications = [
    { label: "Dimensions", value: "10' x 8' x 8.5'" },
    { label: "Floor Area", value: "80 sq ft" },
  ...
  const rentalTerms = [
    ...
    { title: 'Security Deposits', description: '75k within Bangalore and 1 lakh outside Bangalore.' },
  ...
  return (
    <Layout>
      ...
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "@id": "https://www.samanportable.com/container-rent-services/10x8-container-office-rental#service", "name": "10x8 Container Office Rental", "serviceType": "Container Office Rental", "description": "Flexible rental of a 10x8 container office in Bangalore and Delhi NCR, with delivery, professional installation, maintenance support and transparent, refundable-deposit terms.", "provider": {"@id": "https://www.samanportable.com/#organization"}, "areaServed": [{"@type": "Place", "name": "Bengaluru"}, {"@type": "Place", "name": "Delhi NCR"}], "url": "https://www.samanportable.com/container-rent-services/10x8-container-office-rental"}) }}
        />
      </Head>
          ...
          <section className="relative py-16 bg-[#0A3D2A]">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                10x8 Container Office Rental
              </h1>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Compact 80 sq ft container offices perfect for small offices, accommodation, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 10x8 container offices provide the ideal solution for space-constrained locations. 
                    With 80 square feet of usable area, these container offices are perfect for small offices, 
                    accommodation, retail spaces, and commercial applications.
                  </p>
            ...
            <div className="max-w-7xl mx-auto container-padding">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg">
                  Detailed specifications of our 10x8 container office rental units
                </p>
              </div>
          ...
          <section className="section-padding bg-slate-50">
            <div className="max-w-7xl mx-auto container-padding">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Small Offices", description: "Perfect for individual consultants or small teams" },
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 10x8 Container Office?
              </h2>
...
export default ContainerOffice10x8Rental;
