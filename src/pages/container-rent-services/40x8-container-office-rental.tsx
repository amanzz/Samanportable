...
const ContainerOffice40x8Rental = () => {
  const features = [
    "Spacious 320 sq ft interior space",
          ...
          <section className="relative py-16 bg-[#0A3D2A]">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                40x8 Container Office Rental
              </h1>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Spacious 320 sq ft container offices perfect for temporary offices, accommodation, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 40x8 container offices provide the ideal solution for large-scale operations. 
                    With 320 square feet of usable area, these container offices are perfect for 
            ...
            <div className="max-w-7xl mx-auto container-padding">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg">
                  Detailed specifications of our 40x8 container office rental units
                </p>
              </div>
          ...
          <section className="section-padding bg-slate-50">
            <div className="max-w-7xl mx-auto container-padding">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Large Offices", description: "Perfect for project-based work or overflow office space" },
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 40x8 Container Office?
              </h2>
