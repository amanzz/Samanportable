...
const PortaCabin10x10Rental = () => {
  ...
  return (
    <Layout>
      <UnifiedSEO
        fallbackTitle="10x10 Porta Cabin Rental - Saman Portable Office Solutions"
        fallbackDescription="Rent 10x10 ft porta cabins in Bangalore. Compact, high-quality portable cabins perfect for small offices, accommodation, and temporary structures. Flexible rental terms available."
