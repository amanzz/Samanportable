...
const PortaCabin10x10Rental = () => {
  const features = [
    "Compact 100 sq ft interior space",
  ...
  return (
    <Layout>
      <Head>
        <title>10x10 Porta Cabin Rental - Saman Portable Office Solutions</title>
        <meta name="description" content="Rent 10x10 ft porta cabins in Bangalore. Compact, high-quality portable cabins perfect for small offices, accommodation, and temporary structures. Flexible rental terms available." />
      </Head>
          ...
          <section className="relative py-16 bg-[#0A3D2A]">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                10x10 Porta Cabin Rental
              </h1>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
                Compact 100 sq ft portable cabins perfect for small offices, accommodation, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 10x10 porta cabins provide the ideal solution for space-constrained locations. 
                    With 100 square feet of usable area, these cabins are perfect for small offices, 
            ...
            <div className="max-w-7xl mx-auto container-padding">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg">
                  Detailed specifications of our 10x10 porta cabin rental units
                </p>
              </div>
          ...
          <section className="section-padding">
            <div className="max-w-7xl mx-auto container-padding">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg">
                  Get your porta cabin delivered in just a few simple steps
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  ...
                  { step: "4", title: "Ready to Use", description: "Your porta cabin is ready for immediate use" }
                ].map((process, index) => (
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 10x10 Porta Cabin?
              </h2>
