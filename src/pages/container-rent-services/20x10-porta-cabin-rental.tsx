...
const PortaCabin20x10Rental = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>20x10 Porta Cabin Rental - Saman Portable Office Solutions</title>
        <meta name="description" content="Rent 20x10 ft porta cabins in Bangalore. Compact, high-quality portable cabins perfect for small offices, accommodation, and temporary structures. Flexible rental terms available." />
      </Head>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-6">
                    Our 20x10 porta cabins provide the perfect balance of space and efficiency. 
                    With 200 square feet of usable area, these cabins are ideal for small offices, 
          ...
          <section className="section-padding bg-[#0A3D2A] text-white">
            <div className="max-w-7xl mx-auto container-padding text-center">
              <h2 className="text-3xl font-bold mb-6">
                Ready to Rent Your 20x10 Porta Cabin?
              </h2>
