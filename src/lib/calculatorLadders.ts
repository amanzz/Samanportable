...
export const ROUTE_LADDERS: Readonly<Record<string, LadderRow[]>> = {
  ...
  // PO-07 (6 Sep 2026) - the six prices are read from this route's own product JSON
  ...
  // moves, and no existing route's ladder is touched.
  'construction-site-cabin': toRows(constructionSiteCabin),
