...
import sandwichPanelCategory from '@/data/wp-export/categories/sandwich-panel.json';
import securityCabinsCategory from '@/data/wp-export/categories/security-cabins.json';
import wallSheetsCategory from '@/data/wp-export/categories/wall-sheets.json';
