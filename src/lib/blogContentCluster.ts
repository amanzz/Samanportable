...
export const BLOG_CONTENT_CLUSTER: Readonly<Record<string, string>> = Object.freeze({
  ...
  // ── porta-cabins (27; canonical successor to retired portable-cabin hub) ──
  '18-benefits-of-luxury-portable-cabin': 'porta-cabins',
  '7-tips-for-choosing-the-perfect-portable-cabin-location': 'porta-cabins',
  'best-portable-cabins-in-india': 'porta-cabins',
  'cheap-portable-cabins': 'porta-cabins',
  'eco-friendly-portable-cabins': 'porta-cabins',
  'material-specifications-features': 'porta-cabins',
  'portable-cabin-price-in-bangalore': 'porta-cabins',
  'portable-cabin-rental-services': 'porta-cabins',
  'portable-cabins-in-bellandur': 'porta-cabins',
  'portable-cabins-in-central-delhi': 'porta-cabins',
  'portable-cabins-in-east-delhi': 'porta-cabins',
  'portable-cabins-in-faridabad': 'porta-cabins',
  'portable-cabins-in-ghaziabad': 'porta-cabins',
  'portable-cabins-in-greater-noida': 'porta-cabins',
  'portable-cabins-in-gurgaon': 'porta-cabins',
  'portable-cabins-in-hennur': 'porta-cabins',
  'portable-cabins-in-hoskote': 'porta-cabins',
  'portable-cabins-in-hosur': 'porta-cabins',
  'portable-cabins-in-indiranagar': 'porta-cabins',
  'portable-cabins-in-kr-puram': 'porta-cabins',
  'portable-cabins-in-magadi-road': 'porta-cabins',
  'portable-cabins-in-north-delhi': 'porta-cabins',
  'portable-cabins-in-peenya': 'porta-cabins',
  'portable-cabins-in-shivajinagar': 'porta-cabins',
  'portable-cabins-in-south-delhi': 'porta-cabins',
  'portable-cabins-in-west-delhi': 'porta-cabins',
  'top-quality-prefab-cabins-delhi': 'porta-cabins',
