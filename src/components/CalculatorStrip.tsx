...
const CalculatorStrip = () => {
  return (
    <section className="w-full bg-[#0A3D2A] py-12 md:py-16">
        ...
        <div className="flex flex-col items-center gap-8 text-center md:flex-row md:items-center md:justify-between md:gap-10 md:text-left">
          ...
          <div className="flex flex-shrink-0 flex-col items-center gap-2 md:items-end">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-green-500 px-8 py-4 text-base font-black text-[#0A3D2A] shadow-xl transition-all hover:scale-105 hover:bg-green-400 md:text-lg"
            >
