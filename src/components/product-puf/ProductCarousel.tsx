  ...
  return (
    <div className="my-6">
      ...
      >
        <Image
          src={active.src}
          unoptimized={isRemoteImageSrc(active.src)}
          alt={active.alt}
          title={active.title}
          width={800}
          height={800}
          ...
          {images.map((img, index) => (
            ...
            >
              <Image
                ...
                unoptimized={isRemoteImageSrc(img.thumb ?? img.src)}
                alt={img.alt}
                width={150}
                height={150}
                loading="lazy"
        ...
        >
          ...
          <div className="relative max-h-[80vh] w-full max-w-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="relative aspect-square w-full overflow-hidden rounded-xl">
              <Image src={active.src} unoptimized={isRemoteImageSrc(active.src)} alt={active.alt} title={active.title} width={800} height={800} className="h-full w-full object-contain" />
            </div>
