  ...
  return (
    ...
    >
      ...
      >
        ...
        <Image
          src={cert.cert}
          unoptimized={isRemoteImageSrc(cert.cert)}
          alt={cert.certAlt}
          width={1200}
          height={cert.certH}
          ...
          {CERTS.map((c, i) => (
            ...
            >
              ...
              <div className="relative h-[150px] overflow-hidden bg-gray-100">
                <Image src={c.bg} unoptimized={isRemoteImageSrc(c.bg)} alt={c.bgAlt} fill sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 25vw" loading="lazy" className="object-cover" />
                <div className="absolute inset-0 bg-black/45" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="flex h-[72%] w-[58%] items-center justify-center rounded-xl bg-white p-4 shadow-lg">
                    <Image src={c.logo} unoptimized={isRemoteImageSrc(c.logo)} alt="" width={200} height={200} loading="lazy" className="max-h-full max-w-full object-contain" />
                  </span>
                </div>
              </div>
