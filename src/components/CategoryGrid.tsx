...
export const CATEGORIES: CategoryDef[] = [
  ...
  { name: 'PEB Construction', slug: 'pre-engineered-buildings', href: '/product/pre-engineered-buildings', icon: HardHat, description: 'Design-to-erection pre-engineered building projects, managed end to end by our team.' },
