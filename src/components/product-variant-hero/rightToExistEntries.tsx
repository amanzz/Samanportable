...
export interface RightToExistEntry {
  ...
  splitCard?: {
    ...
    subheading?: string;
    body?: string;
    /** PC-06 v1.2 addendum (15 Aug 2026) — optional four-item bullet list rendered
        in the card's copy column, after `body` and before the CTA. Absent on every
        entry except soundproof-porta-cabin, so the hub, MS, GI and with-toilet
