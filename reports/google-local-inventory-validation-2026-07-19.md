# Google Local Inventory Feed Validation - 2026-07-19
...
- Primary Merchant feed products: 276
- Local inventory rows: 552
- Store rows per product: 2
- Store codes: SA201617, 11523617060201819870
- Product availability counts: on_display_to_order=49, in_stock=227
- Row availability counts: on_display_to_order=98, in_stock=454
...
- reports/google-local-inventory-validation-2026-07-19.md
- reports/google-local-inventory-classification-2026-07-19.md
