# PC-05 Fire-Rated Porta Cabin — Self-Contained Copy Pack v2
...
**Supersedes copy pack v1.** v1 is withdrawn: its six variant bodies were single paragraphs, which breaks standing rule 13 (every variant section is Shape A, H2 plus two paragraphs, or Shape B, H2 plus one paragraph plus three to five parallel bullets). v2 reshapes all six and re-measures every field. **Every variant checksum has changed. Do not build from v1.**
...
**Length:** 382 characters · **SHA-256:** `a11a687e1456ef6bf64ee37762a3fd871170e08b8f623d6cc97c95c9979c7641`

```text
With the fire-rated build, you state the required performance and we specify mineral-wool assemblies, fire-grade linings, rated door sets and fire-stopped penetrations to match, with the supporting documentation listed in your quotation. Send your fire criteria, size and site location through our contact page and our engineering team will return a fixed quotation within 48 hours.
```
### V1_H2
...
| S2_P2 | 382 | `a11a687e1456ef6bf64ee37762a3fd871170e08b8f623d6cc97c95c9979c7641` |
