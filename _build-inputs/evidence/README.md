...
Re-issued 6 Sep 2026 after ticket **PO-05-R1** (image-placement repair): the six 16:9
frames moved out of an invented band between Section 2 and Section 3 and into the
Description tab, where the design lock puts its own six. The invented `mediaBand` prop
was reverted.
...
| 6 | `06-verify_po05-output.txt` | **RESULT: PASS**, 332 checks, 0 failures |
...
| — | `07-image-measurements.txt` | 49 outputs, every one 80–120 KB, nothing cropped; the six frames now under `description/` |
| — | `08-validators-baseline-vs-branch.txt` | no new validator failure vs pristine `3c538299`; two pre-existing failure lines repaired; plus the `mediaBand` reversion proof |
