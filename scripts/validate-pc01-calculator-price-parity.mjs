...
const PROTECTED_NORMALIZED_SHA256 = {
  ...
  // PO-07 (6 Sep 2026): re-pinned again on rebase onto PO-06. That branch adds exactly
  // one further additive entry plus its import ('portable-control-room').
  // PO-05 (6 Sep 2026): re-pinned once more, on top of PO-06 and PO-07, both of which
  // merged to static-migration while this branch was open. One further additive
  // ROUTE_LADDERS entry plus its import ('portable-mobile-laboratory', toRows of that
  // route's own product JSON). Verified against origin/static-migration: 42 -> 43 keys,
  // the added key is the ONLY difference, none was removed, and the forty-two
  ...
  ladders: 'bc4dc48414b89602181bcd957a27decb25e0632ed438799476a2320584caa59b',
